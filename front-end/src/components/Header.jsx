	...
	return (
		<header
			className={`fixed z-50 top-0 w-full transition-all duration-300 ${
				scrolled
					? "bg-white/70 backdrop-blur-2xl shadow-md shadow-white/10"
					: "bg-transparent"
			} `}
		>
			<div className="max-w-full flex items-center mx-auto xl:max-w-11/12 justify-between px-10 sm:px-8 py-4 lg:max-w-7xl ">
