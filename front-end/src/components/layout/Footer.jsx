				...
				<div className="flex flex-1 justify-between items-center">
					...
					<div className="flex gap-5">
						<a
							...
							className="size-5 rounded-lg flex items-center justify-center hover:-translate-y-0.5 hover:text-gray-900 transition-all"
						>
						...
						<a
							...
							target="_blank"
							rel="noopener noreferrer"
							className="size-5 rounded-lg flex items-center justify-center hover:-translate-y-0.5 hover:text-blue-500 transition-all"
						>
							<svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
