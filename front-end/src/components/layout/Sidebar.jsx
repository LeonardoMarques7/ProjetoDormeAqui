...
import logoPrimary from "@/assets/logo__primary__mobile.png";
			...
			<SidebarHeader className="w-full">
				...
				>
					<Tooltip>
						<TooltipTrigger asChild>
							<img
								src={logoPrimaryIcon}
								alt="Logo DormeAqui"
								className="h-10 object-contain transition-all w-full duration-300 hidden group-data-[collapsible=icon]:flex"
							/>
						</TooltipTrigger>
					...
					<img
						src={logoPrimary}
						alt="Logo DormeAqui"
						className="h-10 object-contain transition-all duration-300 group-data-[collapsible=icon]:hidden"
					/>
				</Link>
			</SidebarHeader>
