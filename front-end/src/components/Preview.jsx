...
const Preview = ({ data }) => {
	...
	return (
		<Drawer className="mb-10">
			<DrawerTrigger>Open</DrawerTrigger>
			<DrawerContent className=" w-fit py-5 px-10 mx-auto h-full ">
				<div className="container__infos mx-auto !max-w-4xl h-full px-5 overflow-y-auto">
					<div className="bg-primary-900 shadow-2xl max-sm:p-0 max-sm:shadow-none h-fit mt-5 max-sm:mt-15 py-5 max-sm:bg-transparent max-w-full mx-auto w-full object-cover bg-center rounded-4xl  relative overflow-hidden">
					...
					<div className="grid grid-cols-1.5 max-sm:gap-5 gap-2 mt-2 max-sm:mx-2 mx-8 ">
						<div className="leading-relaxed px-0 order-1 max-w-full description ">
							...
							<div className="border max-w-2/3  border-r-0 py-5 mb-5 border-l-0">
								<p
									className=""
