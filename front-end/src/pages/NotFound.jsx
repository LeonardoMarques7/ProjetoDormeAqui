...
export default function NotFound() {
	return (
		<div className="min-h-100 py-15 flex items-center max-sm:rounded-none max-sm:min-h-screen justify-start w-full mx-auto max-w-7xl bg-primary-100/50 rounded-b-2xl">
