...
const Login = () => {
	...
	return (
		<>
			<section className="flex items-center absolute top-[20svh] justify-between sm:px-8 py-4 max-w-7xl  mx-auto ease-in-out duration-500 transition-all">
				<div className="container__image w-1/2 h-[25svh]  flex items-center relative justify-center ease-in-out duration-500 transition-all">
					<img
						src={logo__secondary}
				...
				<div className="max-w-100 mx-auto gap-4 flex flex-col items-center w-full bg-white">
